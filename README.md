...
*   🔭 **Microsoft Stack Expert**: Deep expertise in the .NET ecosystem, ranging from classic .NET Framework to modern **.NET Core / ASP.NET Core**.
*   💻 **Web Development**: Proficient in building robust APIs and interactive front-ends using **Vue.js** and **MVC (Razor)**.
*   📱 **Cross-Platform Mobile**: Experienced in **Flutter** and **Cordova** for multi-endpoint mobile applications.
